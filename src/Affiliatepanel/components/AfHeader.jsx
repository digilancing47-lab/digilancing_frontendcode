...
const AfHeader = ({ onMenuToggle }) => {
  ...
  return (
    <>
      ...
      {/* Desktop Header */}
      <div className="w-full items-center bg-white/5 rounded-2xl backdrop-blur-xl border border-white/10 justify-between hidden lg:flex">
        <div className="flex items-center p-3 rounded-xl w-full space-x-4">
          <div className="flex w-full">
            {image ? (
              <img
                ...
                alt="Profile"
                onClick={()=>{navigate('/Profile')}}
                className="w-12 h-102cursor-pointer rounded-full object-cover"
              />
            ) : (
            ...
            <div className="flex items-center gap-5 pr-5 ml-auto justify-end">
              <a href="/DashBoard" className="text-gray-300 hover:text-[#1e3a8a] cursor-pointer  transition">
                Dashboard
              </a>
              <a href="/courses" className="text-gray-300 hover:text-[#1e3a8a] cursor-pointer  transition">
                Courses
              </a>
              <h1
                onClick={handleLogoutClick}
               className="text-gray-300 hover:text-[#ff3126] cursor-pointer transition"
              >
                Logout
              </h1>
            </div>
